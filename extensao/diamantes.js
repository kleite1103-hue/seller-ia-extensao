      ...
      if (Array.isArray(lista)) {
        COFRE.afiliados.top = lista.slice(0, 5).map(function (af) {
          ...
          return {
            ...
            compradores: n(af.total_buyers),
            novos: n(af.new_buyers),
            pctNovos: (af.new_buyers != null && af.total_buyers) ? (n(af.new_buyers) / n(af.total_buyers)) * 100 : null,
            conversao: n(af.conversion_rate) != null ? n(af.conversion_rate) * 100 : null,
            rede: !!af.is_affiliate_network,
            gmv: n(af.dis_gmv),
